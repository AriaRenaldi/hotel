...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE bookings MODIFY payment_method ENUM('qris','transfer','cash') NOT NULL DEFAULT 'qris'");
        DB::statement("ALTER TABLE payments MODIFY payment_method ENUM('qris','transfer','cash') NOT NULL");
    }
